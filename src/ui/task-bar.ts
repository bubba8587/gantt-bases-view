...
export function createTaskBar(
	...
	// Priority dot + label — only shown when the bar is wide enough to be readable
...
/** Small diamond on the bar marking the completedDate, positioned proportionally. */
function createCompletedMarker(task: GanttTask, bounds: BarBounds): HTMLElement | null {
